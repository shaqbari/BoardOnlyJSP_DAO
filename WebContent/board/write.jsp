...
<script>
	//오라클에 게시물 등록을 *요청*하자
	function regist(){
		//form1.action="write_db.jsp";//앞에 경로를 안적으면 현재폴더를 먼저 찾는다.
		form1.action="/board/write_db.jsp"; //위의 방식은 추천되지 않는다. 맨앞에 root를 표시하는 /를 써주고 경로를 써주자. 
		form1.submit();
	}
</script>
			...
			<tr>
				<td id="list"><table width="100%" border="0" cellspacing="0"
						...
						<tr id="writer">
							...
							<td><input type="text" name="writer"></td><!--db의 컬럼명으로 name다는것이 규칙이다.  -->
						</tr>
						<tr id="title">
